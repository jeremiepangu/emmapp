      ...
      <ErpPageHeader
        ...
        actions={
          <>
            ...
            {can('payments', 'create') && <button type="button" className="erp-btn" onClick={() => { setEditing(null); setForm({ clientId: '', orderId: '', amount: 0, method: 'ESPECES', reference: '' }); setError(''); setShowForm(true); }}>+ Encaissement</button>}
          </>
        }
      />
      <ErpPanel
